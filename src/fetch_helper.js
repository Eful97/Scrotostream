const FETCH_TIMEOUT = 12000; // 12 seconds - reduced from 30s
const CONTEXT_TIMEOUT = 2500; // 2.5 seconds for context
...
module.exports = { fetchWithTimeout, createTimeoutSignal, FETCH_TIMEOUT, CONTEXT_TIMEOUT };
